...
function onCreate()
	...
	makeLuaSprite('bgThing', 'songBG4', -550, 410)
    ...
    if count < 15 then
        ...
        makeIt = true
        makeLuaText('songText', "".. useName, 400, getProperty('bgThing.x') + 180, 550) -- Too big song name
        setObjectCamera("songText", 'other');
        setTextColor('songText', '0x'..songTxtColor)
    ...
    if makeIt == true then -- too big of a song name
        makeLuaText('optionalText', " / ".. toughnessSmal, 400, getProperty('bgThing.x') + 180, 550)
